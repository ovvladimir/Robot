...
class index:
    def GET(self):
        accel_xout = twos_compliment(0x3b)
        accel_yout = twos_compliment(0x3d)
        accel_zout = twos_compliment(0x3f)

        accel_xout_scaled = accel_xout / 16384.0
        accel_yout_scaled = accel_yout / 16384.0
        accel_zout_scaled = accel_zout / 16384.0

        return f'{get_x_rotation(accel_xout_scaled, accel_yout_scaled, accel_zout_scaled)} {get_y_rotation(accel_xout_scaled, accel_yout_scaled, accel_zout_scaled)}'
